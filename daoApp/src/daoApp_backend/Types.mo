...
module {
  ...
  public type ProposalState = {
    // önerinin yürütülmesi sırasında bir hata oluştu
      #failed : Text;
    // öneri oy vermeye açık
      #open;
    // öneri şu anda yürütülüyor
      #executing;
    // yeterli sayıda "hayır" oyu verildi ve öneri reddedildi, yürütülmeyecek
      #rejected;
    // öneri başarıyla yürütüldü
      #succeeded;
    // yeterli sayıda "evet" oyu verildi ve öneri kabul edilecek ve yakında yürütülecek
      #accepted;
  };
  ...
  public type SystemParams = {
    ...
    // bir öneriyi kabul etmek için "evet" oyu vermek veya reddetmek için "hayır" oyu vermek için gereken token miktarı
    proposal_vote_threshold: Tokens;

    // bir kullanıcının bir öneri gönderdiğinde hesabından geçici olarak düşürülecek token miktarı.
    // öneri Kabul edilirse, bu depozit geri verilir, aksi takdirde kaybedilir.
    // bu, kullanıcıların gereksiz öneriler göndermesini engeller.
    proposal_submission_deposit: Tokens;
  };
