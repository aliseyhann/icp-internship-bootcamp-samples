...
shared actor class DAO(init : Types.BasicDaoStableStorage) = Self {
    ...
    // cağrının hesabından başka bir hesaba token transferi yapar
    ...
    // cağrının hesap bakiyesini döndürür
    ...
    // bir öneri gönder
    /* bir öneri, bir canister kimliği, yöntem adı ve yöntem argümanları içerir. Yeterli kullanıcı "evet" oyu verirse,
    belirtilen yöntem belirtilen argümanlarla belirtilen canister üzerinde çağrılır. */
        ...
        case (?proposal) {
                 ...
                 case (?{ amount_e8s = voting_tokens }) {
                          ...
                          if (votes_yes >= system_params.proposal_vote_threshold.amount_e8s) {
                                // öneri kabul edildiğinde öneri depozitini geri öde
                              ignore do ? {
    ...
    // sadece öneri yürütme aracılığıyla çağrılabilir
    ...
    // öneri gönderim depozitosunu çağrının hesabından düşür
    ...
    // kabul edilen tüm önerileri yürüt
